// Data Al-Ma'tsurat (Sugro) — Dzikir Pagi.
// Struktur tiap item: { count, title, arabic, latin, translation, faedah, sumber }
// count = jumlah pengulangan bacaan.
window.ALMATSURAT_PAGI = [
  {
    "count": 1,
    "title": "Ta'awudz",
    "arabic": "اَعُوْذُ بِاللّٰهِ السَّمِيْعِ الْعَلِيْمِ مِنَ الشَّيْطَانِ الرَّجِيْمِ",
    "latin": "A'udzubillahissami'il aliimi minasyaithanirrajiim",
    "translation": "Aku berlindung kepada Allah Yang Maha Mendengar lagi Maha Mengetahui dari godaan setan yang terkutuk.",
    "faedah": "Memohon perlindungan kepada Allah dari godaan setan sebelum memulai bacaan dan aktivitas.",
    "sumber": "Sunnah membaca ta'awudz sebelum membaca Al-Qur'an (QS. An-Nahl: 98)."
  },
  {
    "count": 1,
    "title": "QS. Al-Fatihah : 1-7",
    "arabic": "بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ ۝ اَلْحَمْدُ لِلّٰهِ رَبِّ الْعٰلَمِيْنَۙ ۝ الرَّحْمٰنِ الرَّحِيْمِۙ ۝ مٰلِكِ يَوْمِ الدِّيْنِۗ ۝ اِيَّاكَ نَعْبُدُ وَاِيَّاكَ نَسْتَعِيْنُۗ ۝ اِهْدِنَا الصِّرَاطَ الْمُسْتَقِيْمَۙ ۝ صِرَاطَ الَّذِيْنَ اَنْعَمْتَ عَلَيْهِمْ ەۙ غَيْرِ الْمَغْضُوْبِ عَلَيْهِمْ وَلَا الضَّاۤلِّيْنَ ࣖ",
    "latin": "Bismillaahirrahmaanirrahiiim. Alhamdulillaahi rabbil 'aalamiin. Arrahmaanirrahiim. Maaliki yaumid-diin. Iyyaaka na'budu wa iyyaaka nasta'iin. Ihdinash-shiraathal mustaqiim. Shiraathal-ladziina an'amta 'alaihim, ghairil-maghdhuubi 'alaihim waladh-dhaaaalliin.",
    ...
    "faedah": "Induk Al-Qur'an (Ummul Kitab); bacaan yang menghimpun pujian, tauhid, dan permohonan hidayah.",
    "sumber": "QS. Al-Fatihah: 1-7; HR. Bukhari."
  },
  {
    "count": 1,
    "title": "QS. Al-Baqarah : 1-5",
    "arabic": "بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيْمِ ۝ اَلۤمّۤ ۚ ۝ ذٰلِكَ الْكِتٰبُ لَا رَيْبَ ۛ فِيْهِ ۛ هُدًى لِّلْمُتَّقِيْنَۙ ۝ الَّذِيْنَ يُؤْمِنُوْنَ بِالْغَيْبِ وَيُقِيْمُوْنَ الصَّلٰوةَ وَمِمَّا رَزَقْنٰهُمْ يُنْفِقُوْنَ ۙ ۝ وَالَّذِيْنَ يُؤْمِنُوْنَ بِمَآ اُنْزِلَ اِلَيْكَ وَمَآ اُنْزِلَ مِنْ قَبْلِكَ ۚ وَبِالْاٰخِرَةِ هُمْ يُوْقِنُوْنَۗ ۝ اُولٰۤىِٕكَ عَلٰى هُدًى مِّنْ رَّبِّهِمْ ۙ وَاُولٰۤىِٕكَ هُمُ الْمُفْلِحُوْنَ ۝",
    "latin": "Bismillaahirrahmaanirrahiiim. Alif laam miim. Dzaalikal–kitaabu laa raiba fiihi hudal lil-muttaqiin. Alladziina yu'minuuna bil ghaibi wa yuqiimuunash-shalaata wa mimmaa razaqnaahum yunfiquun. Wal-ladziina yu'minuuna bimaa unzila ilaika wa maa unzila min qablik, wa bil aakhirati hum yuuqinuun. Ulaa-ika 'alaa hudammir rabbihim wa ulaa-ika humul muflihuun.",
    "translation": "Alif lam mim. Kitab (Al-Qur'an) ini tidak ada keraguan padanya; petunjuk bagi mereka yang bertakwa. (Yaitu) mereka yang beriman kepada yang ghaib, mendirikan shalat, dan menafkahkan sebagian rezeki yang Kami berikan kepada mereka. Dan mereka yang beriman kepada Kitab (Al-Qur'an) yang telah diturunkan kepadamu dan kitab-kitab yang telah diturunkan sebelummu, serta mereka yakin akan adanya (kehidupan) akhirat. Mereka itulah yang tetap mendapat petunjuk dari Tuhannya, dan merekalah orang-orang yang beruntung.",
    "faedah": "Menegaskan ciri orang bertakwa dan keimanan kepada yang ghaib; pembuka surah Al-Baqarah.",
    "sumber": "QS. Al-Baqarah: 1-5."
  },
  {
    "count": 1,
    "title": "QS. Al-Baqarah : 255-257 (Ayat Kursi)",
  ...
  },
  {
    "count": 3,
    "title": "Dzikir Pagi",
    "arabic": "أَصْبَحْنَا وَأَصْبَحَ الْمُلْكُ لِلّٰهِ، وَالْحَمْدُ لِلّٰهِ، لَا شَرِيْكَ لَهُ، لَا إِلٰهَ إِلَّا هُوَ وَإِلَيْهِ النُّشُوْرُ",
    "latin": "Ashbahnaa wa ashbahal-mulku lillaahi walhamdu lillaahi, laa syariika lahu, laa ilaaha illa huwa wa ilaihin-nusyuur.",
    "translation": "Kami masuk waktu pagi dan masuk waktu pagi pula kerajaan milik Allah. Segala puji bagi Allah, tidak ada sekutu bagi-Nya, tidak ada Tuhan selain Dia, dan kepada-Nya tempat kebangkitan.",
    "faedah": "Pengakuan bahwa kerajaan dan segala pujian hanya milik Allah saat memasuki waktu pagi.",
    "sumber": "HR. Muslim dari Abdullah bin Mas'ud."
  },
  {
    "count": 3,
    "title": "Dzikir Pagi",
    "arabic": "اَصْبَحْنَا عَلَى فِطْرَةِ الْإِسْلَامِ، وَكَلِمَةِ الْإِخْلَاصِ، وَعَلَى دِيْنِ نَبِيِّنَا مُحَمَّدٍ ﷺ وَعَلَى مِلَّةِ أَبِيْنَا إِبْرَاهِيْمَ حَنِيْفًا وَمَا كَانَ مِنَ الْمُشْرِكِيْنَ",
    "latin": "Ashbahna 'ala fithratil Islaam, wa kalimatil ikhlash, wa 'alaa diini nabiyinaa Muhammadin shallaallahu 'alaihi wasalam wa 'ala millati abiinaa Ibraahima haniifan wa maa kana minal musyrikiin.",
    "translation": "Kami masuk waktu pagi di atas fitrah Islam dan kalimat tauhid, di atas agama Nabi kami Muhammad SAW, dan di atas ajaran bapak kami Ibrahim as yang hanif. Dan ia bukan termasuk golongan orang-orang yang musyrik.",
  ...
  },
  {
    "count": 3,
    "title": "Dzikir & Doa",
    "arabic": "اللّٰهُـمَّ إِنِّيْ أَصْبَحْتُ مِنْكَ فِيْ نِعْمَةٍ وَعَافِيَةٍ وَسِتْرٍ, فَأَتِمَّ عَلَيَّ نِعْمَتَكَ وَعَافِيَتَكَ وَسِتْرَكَ فِيْ الدِّيْنِ وَالدُّنْيَا وَالْأَخِرَةِ",
    "latin": "Allahumma innii ashbahtu minka, fii ni'matin wa'aafiyatin wa sitrin fa atimma 'alaiyya ni'mataka wa'aafiyataka wasitraka fiddunyaa wal akhirah.",
    "translation": "Yaa Allah, sesungguhnya aku memulai pagi ini dengan kenikmatan, kesehatan, dan perlindungan-Mu. Maka sempurnakanlah untukku kenikmatan, kesehatan, dan perlindungan-Mu itu dalam agamaku, dunia dan juga akhirat.",
  ...
  },
  {
    "count": 3,
    "title": "Dzikir Pagi",
    "arabic": "اَللّٰهُـمَّ مَا أَصْبَحَ بِيْ مِنْ نِعْمَةٍ , أَوْ بِأَحَدٍ مِنْ خَلْقِكَ فَمِنْكَ وَحْدَكَ , لَا شَرِيْكَ لَكَ , فَلَكَ الْحَمْدُ , وَلَكَ الشُّكْرُ",
    "latin": "Allahumma maa ashbaha bii min ni'matin aubiahadin min kholqika faminka wahdaka laa syarikalaka falakal hamdu walakasyukru.",
    "translation": "Yaa Allah, segala nikmat yang pagi ini menyertaiku atau siapa pun di antara makhluk-Mu, hanyalah dari-Mu semata tiada sekutu bagi-Mu, maka bagi-Mu segala puji dan bagi-Mu rasa syukur.",
  ...
  },
  {
    ...
    "faedah": "Pujian yang layak bagi kemuliaan dan keagungan Allah.",
    "sumber": "HR. Ibnu Majah."
  },
  {
    "count": 3,
    "title": "Dzikir & Doa",
    "arabic": "رَضِيتُ بِاللهِ رَبًّا. وَبِالْإِسْلَامِ دِيْنًا. وَبِمُحَمَّدٍ نَبِيًّا وَرَسُوْلاً",
  ...
  },
  {
    "count": 3,
    "title": "Doa",
    "arabic": "اللّٰهُـمَّ عَافِنِي فِي بَدَنِي،, اللّٰهُـمَّ عَافِنِي فِي سَمْعِي،, اللّٰهُـمَّ عَافِنِي فِي بَصَرِي،, اللّٰهُـمَّ عَافِنِيْ فِيْ قَلْبِيْ",
  ...
  {
    "count": 3,
    "title": "Dzikir & Doa (Sayyidul Istighfar)",
  ...
  },
  {
    "count": 10,
    "title": "Shalawat",
    "arabic": "اللّٰهُـمَّ صَلِّ عَلَى سَيِّدِنَا مُحَمَّدٍ وَعَلَى آلِ سَيِّدِنَا مُحَمَّدٍ،, كَمَا صَلَّيْتَ عَـلَى سَيِّدِنَا إِبْرَاهِيْمَ وَعَلَى آلِ سَيِّدِنَا إِبْرَاهِيْمَ،, وَبَارِكْ عَلَى سَيِّدِنَا مُحَمَّدٍ وَعَلَى آلِ سَيِّدِنَا مُحَمَّدٍ،, كَمَا بَارَكْتَ عَلَى سَيِّدِنَا إِبْرَاهِيْمَ وَعَلَى آلِ سَيِّدِنَا إِبْرَاهِيْمَ , فِيْ الْعَالَمِيْنَ، إِنَّكَ حَمِيْدٌ مَجِيْدٌ",
  ...
  },
  {
    "count": 1,
    "title": "Shalawat",
    "arabic": "اللّٰهُـمَّ صَلِّ عَلَى سَيِّدِنَا مُحَمَّدٍ عَبْدِكَ وَرَسُوْلِكَ النَّبِيِّ الْأُمِّيِّ وَعَلَى آلِهِ وَصَحْبِهِ وَسَلِّمْ تَسْلِيْمًا عَدَدَمَا أَحَاطَ بِهِ عِلْمُكَ وَخَطَّ بِهِ قَلَمُكَ وَأَحْصَاهُ كِتَابُكَ،, وَارْضَ اللَّهُمَّ عَنْ سَادَاتِنَا أَبِي بَكْرٍ وَعُمَرَ وَعُثْمَانَ وَعَلِيٍّ،, وَعَنِ الصَّحَابَةِ أَجْمَعِيْنَ،, وَعَنِ التَّابِعِيْنَ وَتَابِعِيْهِمْ بِإِحْسَانٍ إِلَى يَوْمِ الدِّيْنِ",
    "latin": "Allaahumma shalli 'alaa sayyidina muhammadin 'abdika wa rosuulikannabiyyil ummiyyi wa 'alaa aalihi wa shahbihi wa sallama tasliiman 'adada maa ahaatha bihi 'ilmuka wa khath-thabihi qalamuka wa ahshaahu kitaabuka, wardhallaahumma 'an saadaatinaa abii bakrin wa 'umara wa 'utsmaana wa 'alii, wa 'anish-shahaabati ajma'iin, wa 'anit-taabi'iina wa taabi'iihim bi ihsaanin ilaa yaumiddiin.",
    ...
    "faedah": "Shalawat dan salam kepada Nabi ﷺ beserta keluarga dan sahabat, serta doa keridhaan bagi para sahabat dan tabi'in.",
    "sumber": "Bagian dari susunan Al-Ma'tsurat oleh Imam Hasan Al-Banna."
  },
  {
    "count": 1,
    "title": "Dzikir",
    "arabic": "سُبْحَانَ رَبِّكَ رَبِّ الْعِزَّةِ عَمَّا يَصِفُوْنَ , وَسَلَامٌ عَلَى الْمُرْسَلِيْنَ , وَالْحَمْدُ لِلّٰهِ رَبِّ الْعَالَمِيْنَ",
    "latin": "Subhaana rabbika rabbil'izzati 'amma yashifuuna wasalaamun 'alal mursaliin, walhamdulillahirabbil 'aalamiina.",
    "translation": "Maha Suci Tuhanmu, Pemilik segala kemuliaan dari apa-apa yang mereka sifatkan. Keselamatan semoga tercurah kepada para utusan dan segala puji bagi Allah. Tuhan sekalian alam.",
    "faedah": "Penutup dengan penyucian Allah, salam bagi para rasul, dan pujian bagi Allah (penutup surah Ash-Shaffat).",
  ...
  },
  {
    ...
    "latin": "Qulillaahumma maalikal mulki tu'til mulka man tasyaa-u wa tanzi'ul mulka mimman tasyaa-u wa tu'izzu man tasyaa-u wa tudzillu man tasyaa-u biyadikal khairu innaka 'alaa kulli syai-in qadiir. Tuulijul-layla fin-nahaari wa tuulijun-nahaara fil-layli wa tukhrijul hayya minal mayyiti wa tukhrijul mayyita minal hayyi wa tarzuqu man tasyaa-u bighairi hisaab.",
    ...
    "faedah": "Doa memohon kebaikan dari Pemilik kerajaan, kemuliaan, dan rezeki tanpa batas.",
    "sumber": "QS. Ali 'Imran: 26-27."
  },
  {
    "count": 1,
    "title": "Dzikir",
    "arabic": "اللَّهُمَّ إِنَّ هَذَا إِقْبَالُ نَهَارِكَ، وَإِدْبَارُ لَيْلِكَ، وَأَصْوَاتُ دُعَاتِكَ، فَاغْفِرْ لِي",
    "latin": "Allaahumma inna haadzaa iqbaalu nahaarika wa idbaaru lailika, wa ashwaatu du'aatika, faghfir lii.",
    "translation": "Ya Allah, sesungguhnya inilah saat datangnya siang-Mu dan perginya malam-Mu, serta suara-suara penyeru-Mu (muadzin), maka ampunilah aku.",
    "faedah": "Doa saat datangnya siang dan perginya malam, memohon ampunan.",
    "sumber": "HR. Abu Dawud, Tirmidzi."
  },
  {
    "count": 1,
    "title": "Doa Rabithah",
    "arabic": "اللّٰهُمَّ إِنَّكَ تَعْلَمُ أَنَّ هٰذِهِ الْقُلُوْبَ قَدِ اجْتَمَعَتْ عَلَىٰ مَحَبَّتِكَ، وَالْتَقَتْ عَلَىٰ طَاعَتِكَ، وَتَوَحَّدَتْ عَلَىٰ دَعْوَتِكَ، وَتَعَاهَدَتْ عَلَىٰ نُصْرَةِ شَرِيْعَتِكَ، فَوَثِّقِ اللّٰهُمَّ رَابِطَتَهَا، وَأَدِمْ وُدَّهَا، وَاهْدِهَا سُبُلَهَا، وَامْلَأْهَا بِنُوْرِكَ الَّذِيْ لَا يَخْبُو، وَاشْرَحْ صُدُوْرَهَا بِفَيْضِ الْإِيْمَانِ بِكَ، وَجَمِيْلِ التَّوَكُّلِ عَلَيْكَ، وَأَحْيِهَا بِمَعْرِفَتِكَ، وَأَمِتْهَا عَلَى الشَّهَادَةِ فِيْ سَبِيْلِكَ، إِنَّكَ نِعْمَ الْمَوْلَىٰ وَنِعْمَ النَّصِيْرُ",
    "latin": "Allaahumma innaka ta'lamu anna haadzihil quluuba qadijtama'at 'alaa mahabbatika, waltaqat 'alaa thaa'atika, wa tawahhadat 'alaa da'watika, wa ta'aahadat 'alaa nushrati syarii'atika, fawats-tsiqillaahumma raabithatahaa, wa adim wuddahaa, wahdihaa subulahaa, wamla'haa binuurikalladzii laa yakhbuu, wasyrah shuduurahaa bifaydhil iimaani bika, wa jamiilit-tawakkuli 'alayka, wa ahyihaa bima'rifatika, wa amit-haa 'alasy-syahaadati fii sabiilika, innaka ni'mal maulaa wa ni'man-nashiir.",
    ...
    "faedah": "Doa Rabithah — mempererat ikatan hati sesama mukmin di atas cinta, ketaatan, dan dakwah di jalan Allah.",
    "sumber": "Susunan doa dalam Al-Ma'tsurat oleh Imam Hasan Al-Banna."
  },
  {
    "count": 1,
    "title": "Shalawat & Doa Penutup",
    "arabic": "اَللّٰهُمَّ اٰمِيْنَ، وَصَلِّ اللّٰهُمَّ عَلَى سَيِّدِنَا مُحَمَّدٍ وَعَلَى اٰلِهٖ وَصَحْبِهٖ وَسَلِّمْ",
    "latin": "Allaahumma aamiin, wa shallillaahumma 'alaa sayyidinaa muhammadin wa 'alaa aalihi wa shahbihi wa sallam.",
    "translation": "Ya Allah kabulkanlah. Dan semoga shalawat serta salam selalu tercurahkan kepada junjungan kami Muhammad, kepada keluarganya dan kepada semua sahabatnya.",
    "faedah": "Doa penutup: memohon pengabulan (aamiin) serta shalawat dan salam bagi Nabi ﷺ, keluarga, dan sahabatnya.",
    "sumber": "Penutup susunan Al-Ma'tsurat oleh Imam Hasan Al-Banna."
  }
];
